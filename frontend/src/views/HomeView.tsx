  ...
  return (
    <div className="flex-1 overflow-y-auto no-scrollbar" style={{ paddingTop: 36, paddingBottom: 38 }}>
      ...
      <div className="px-3 mt-4 mb-2 space-y-2.5">
        ...
        {(settings.facebook_url || settings.whatsapp_number) && (
          <div className="grid grid-cols-2 gap-2.5">
            {settings.facebook_url && (
              <a
                ...
                className="h-10 bg-surface border border-outline hover:border-blue-500 rounded-lg flex items-center justify-center gap-2 text-white/90 hover:text-white font-sans text-xs font-bold uppercase transition-all"
              >
                <svg className="w-4.5 h-4.5 fill-current text-blue-500" viewBox="0 0 24 24">
            ...
            {settings.whatsapp_number && (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="h-10 bg-surface border border-outline hover:border-green-500 rounded-lg flex items-center justify-center gap-2 text-white/90 hover:text-white font-sans text-xs font-bold uppercase transition-all"
              >
                <svg className="w-4.5 h-4.5 fill-current text-green-500" viewBox="0 0 24 24">
