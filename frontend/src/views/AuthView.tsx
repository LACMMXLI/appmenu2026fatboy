...
export function AuthView({ onNavigate, onLogin }: AuthViewProps) {
  ...
  return (
    <div className="h-full flex flex-col bg-background w-full max-w-md mx-auto relative overflow-hidden">
      ...
      <div className="flex-1 min-h-0 overflow-y-auto no-scrollbar px-6 py-4 flex flex-col">
        <div className="my-auto w-full flex flex-col items-center">
          <img 
            src="/images/logo.png" 
            alt="FATBOY" 
            className="h-20 w-auto object-contain mb-4 animate-fade-in-up stagger-1 drop-shadow-[0_0_15px_rgba(255,255,255,0.15)] shrink-0"
          />
