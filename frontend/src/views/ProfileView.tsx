        ...
        <div className="flex flex-col gap-2.5 w-full">
          ...
          <div className="w-full shrink-0">
            ...
            <div className="bg-surface border border-outline/60 rounded-xl overflow-hidden divide-y divide-outline/50">
              ...
              <a href="https://www.facebook.com/AhhPlebeesFatBoyRestaurant/" target="_blank" rel="noopener noreferrer" className="w-full flex items-center justify-between px-3 py-2 hover:bg-surface-hover transition-colors">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-xs font-semibold text-white">Facebook Fatboy</span>
                </div>
                <ChevronRight size={13} className="text-gray-500" />
              </a>
