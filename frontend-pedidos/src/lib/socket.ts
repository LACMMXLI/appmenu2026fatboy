 ...
 * `token` is the StaffSession token used for HTTP — the server
 * authenticates it before the connection is even accepted (see backend
 * orders.gateway.ts). Never pass a staffId/branchId instead.
 */
