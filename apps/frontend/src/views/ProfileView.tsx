...
export function ProfileView({ onNavigate }: ProfileViewProps) {
  const { points, customer, logout } = useUser();
  ...
  return (
    <div className="flex-1 overflow-y-auto pt-[42px] pb-[42px] px-3">
      {/* User Info Card */}
      <div className="bg-surface border border-outline/50 p-3.5 rounded-xl flex items-center gap-3 mb-3 relative overflow-hidden">
      ...
      {/* Points Card */}
      <div className="bg-surface border border-outline/50 p-3.5 rounded-xl mb-3">
      ...
      <div className="w-full mb-4">
        ...
        <div className="bg-surface border border-outline/50 rounded-xl overflow-hidden divide-y divide-outline/50">
          {[
            ...
            { icon: Star, label: 'Calificarnos en Google', action: () => onNavigate('google-review') },
          ].map((item, i) => (
